    ...
    if (document.getElementById(formid) != null) {
        ...
        if (document.getElementsByTagName) {
            ...
            for (var formCount = 0; formCount < formInput.length; formCount++) {
                formInput[formCount].onkeyup = function() {
                    return validation(this);
                }
                formInput[formCount].onblur = function() {
                    return validation(this);
                }
            }
        }
        ...
        if (document.getElementsByTagName) {
            ...
            for (var formCount = 0; formCount < formText.length; formCount++) {
                formText[formCount].onkeyup = function() {
                    return validation(this);
                }
                formText[formCount].onblur = function() {
                    return validation(this);
                }
            }
        }
        ...
        if (formButt) formButt.onclick = function() {
            sendEmail();
        }
    }
}
