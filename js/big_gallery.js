...
$(window).load(function() {
    ...
    if (!$page.length) {
        ...
        var cfs = $gallery.carouFredSel({
            ...
            scroll: {
                ...
                onBefore: function(oldItems, newItems) {
                    ...
                    $('#slider div.caroufredsel_wrapper').animate({
                        marginLeft: margin
                    }, 11);
                    ...
                    $('#slider div.caroufredsel_wrapper').css({
        ...
        var cfs2 = $thumbnails.carouFredSel({
            ...
            prev: {
                onAfter: function() {
                    $mini_next.fadeIn();
                    right = true;
                    if (scroll_prev && !agentID) setTimeout(function() {
            ...
            next: {
                onAfter: function() {
                    ...
                    $mini_prev.fadeIn();
                    left = true;
                    if (scroll_next && !agentID) setTimeout(function() {
        ...
        $gallery_hide.css({
            bottom: -w_height - $gallery_hide.innerHeight() + 'px'
        });
        ...
        $mini_cont.css({
            bottom: -w_height - $mini_cont.innerHeight() - $gallery_hide.innerHeight() + 'px'
        });
        ...
        if (!agentID) {
            $("#thumbnails_bg").hover(function() {},
                function() {
                    thumb_shown = false;
                    $($gallery_hide, this).stop().animate({
                        bottom: -w_height - $gallery_hide.innerHeight() + 'px'
                    }, {
                        queue: false,
                        duration: 1500
            ...
            $gallery_show.hover(function() {
                ...
                $($gallery_hide, this).stop().animate({
                    bottom: $mini_cont.innerHeight() + 'px'
                }, 500, "linear");
                $mini_cont.stop().animate({
                    bottom: '0px'
                }, 500, "linear", function() {
            ...
            if ($('#desc_' + $(this).attr('class')).html()) {
                $('#desc_' + $(this).attr('class')).modal({
                    ...
                    onShow: function() {
                        ...
                        $slider_wrapper.css({
                            'height': this_wrapper_h
                        });
                        $gallery.css({
                            'height': this_gallery_h
                        });
                    },
                    onClose: function() {
    ...
    if (!$page.length && logoHide != 0) {
        ...
        $desc_info.hover(function() {
            hovered = true;
        }, function() {
            hovered = false;
        });
        $video_desc_info.hover(function() {
            hovered = true;
        }, function() {
            hovered = false;
        });
    ...
    $(".simplemodal-close").css({
        ...
        .mouseover(function() {
            $("a.modalCloseImg simplemodal-close").stop().animate({
    ...
    if ($("#example_video").length || $("#youtubevideo").length || $("#vimeovideo").length) {
        ...
        if ($("#example_video").length) {
            ...
            if (player_width / player_height >= w_width / w_height) {
                $("#vimeovideo").css({
                    'width': player_width * w_height / player_height + 'px',
                    'height': w_height + 'px'
                })
                pw = player_width * w_height / player_height;
                ph = w_height;
                ...
                $("#vimeovideo").css({
                    'width': w_width + 'px',
                    'height': player_height * w_width / player_width + 'px'
                })
                pw = w_width;
                ph = player_height * w_width / player_width;
            }
    ...
    if ($(".rslides").length) {
        ...
        $(".rslides img").each(
            function(index) {
                if ($(this).innerHeight() < min_h) {
                    min_h = $(this).innerHeight();
                }
            });
    ...
    $(window).on("debouncedresize", function(event) {
        ...
        if ($('#slider').length) {
            cfs.configuration("height", w_height);
        }
        $('#slider div.caroufredsel_wrapper').css("height", w_height - margin_top + 'px');
